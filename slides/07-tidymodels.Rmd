...
knitr::opts_chunk$set(fig.path = "figures/_gen/07/")
...
knitr::include_graphics(file.path(fig_path, "07-tidymodels-workflow.png"))
```
...
background-image: url("figures/07-caret-obs.png")
...
knitr::include_graphics(file.path(fig_path, "07-parsnip.png"))
```
...
knitr::include_graphics(file.path(fig_path, "07-yardstick.png"))
```
...
knitr::include_graphics(file.path(fig_path, "07-rsample.png"))
```
...
knitr::include_graphics(file.path(fig_path, "07-tune.png"))
```
...
knitr::include_graphics(file.path(fig_path, "07-recipes.png"))
```
