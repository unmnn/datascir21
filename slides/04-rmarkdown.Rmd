...
knitr::opts_chunk$set(fig.path = "figures/_gen/04/")
...
- repetitive and tedious manual workflow
- raw data is stored in Excel
- then manually run data analysis scripts in R
- make charts
- copy-paste results and visualizations into your docx, pptx or latex file
- maybe you do the analysis already during the data collection phase and you get 2 more observations which forces you to redo all of these steps
- R Markdown is a suitable tool to automatize such a workflow.
...
- [Components of an `.Rmd` file](#structure): Markdown, Code, YAML
...
knitr::include_graphics(file.path(fig_path, "04-rmarkdown-logo.png"))
```

&nbsp;

```{r 1-file-3-outputs, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics(file.path(fig_path, "04-three_outputs.png"))
```
...
knitr::include_graphics(file.path(fig_path, "04-rmarkdown_sketch.png"))
```
...
A .Rmd file contains narrative text in Markdown syntax and (`R`) code.
The `knitr` package provides functions to execute the code, collect the results (statistics, tables, plots, etc.) and combine them with the Markdown text into a Markdown file (.md). 
Pandoc, a universal document converter, then converts this Markdown file into the requested output format, e.g., .html, .pdf or .docx.
...
```{r rmd-first-example-1, echo=FALSE, out.width="100%", fig.align='center'}
knitr::include_graphics(file.path(fig_path, "04-rmd_first_example_1.png"))
```
...
knitr::include_url("04-rmd-intro.html", height = "500px")
```
...
knitr::include_graphics(file.path(fig_path, "04-html_example.png"))
```
...
knitr::include_graphics(file.path(fig_path, "04-rstudio-markdown-quick-ref-1.png"))
```
...
Code chunks can be inserted with the `r knitr::include_graphics(file.path(fig_path, "04-insert.png"))` button in the toolbar or using the keyboard shortcut **Ctrl + Alt + I**.
...
knitr::include_graphics(file.path(fig_path, "04-knitr.png"))
```
...
knitr::include_graphics(file.path(fig_path, "04-chunk.png"))
```
...
knitr::include_url(file.path(fig_path, "04-dt-iris.html"))
```
]
...
- using RStudio via the `r knitr::include_graphics(file.path(fig_path, "04-knit.png"))` button
...
knitr::include_graphics(file.path(fig_path, "04-pandoc.png"))
```
...
knitr::include_graphics(file.path(fig_path, "04-yaml.jpg"))
```
...
knitr::include_graphics(file.path(fig_path, "04-yaml-options.png"))
```
...
The **rticles** package provides a suite of custom [R Markdown](https://rmarkdown.rstudio.com) 
LaTeX formats and templates for various formats, including:

- [ACM](https://www.acm.org/) articles
- [ACS](https://pubs.acs.org/) articles
- [AMS](https://www.ametsoc.org/) articles
- [Elsevier](https://www.elsevier.com) journal submissions
- [IEEE Transaction](https://journals.ieeeauthorcenter.ieee.org/create-your-ieee-journal-article/authoring-tools-and-templates/tools-for-ieee-authors/ieee-article-templates/) journal submissions
...
- [Taylor & Francis](https://taylorandfrancis.com/) articles
...
- Hadley Wickham, and Garrett Grolemund. ["R for Data Science"](https://r4ds.had.co.nz/). O'Reilly, 2017. Chapters: 
  - [R Markdown](https://r4ds.had.co.nz/r-markdown.html)
  - [R Markdown formats](https://r4ds.had.co.nz/r-markdown-formats.html)
  - [R Markdown workflow](https://r4ds.had.co.nz/r-markdown-workflow.html)
...
knitr::include_graphics(file.path(fig_path, "04-rmarkdown_book.png"))
```
